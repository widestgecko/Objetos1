...
public class App {
    public static void main(String[] args) {
        ...
        miequipo.reporte();
        miequipo.agregarJugador(new JugadorEntrenador("Francisco Zapeda", 'H', "Entrenador Principal", 1000, 8,1), null);
        miequipo.agregarJugador(new JugadorEntrenador("Alexis Estrada", 'H', "Entrenador de Apoyo", 900, 10,2), null);
